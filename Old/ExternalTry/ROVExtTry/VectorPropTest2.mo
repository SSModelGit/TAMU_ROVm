...
model VectorPropTest2
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder4(T = 1) annotation(Placement(visible = true, transformation(origin = {-50, -55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Continuous.FirstOrder firstOrder5(T = 1) annotation(Placement(visible = true, transformation(origin = {48.603, -55}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  ExternalTry.ROVExtTry.PropControl6 propControl6(c = 14.8) annotation(Placement(visible = true, transformation(origin = {-135, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(propControl6.u[1], firstOrder1.u) annotation(Line(visible = true, origin = {-17.819, 35}, points = {{-106.431, -35}, {34.477, -35}, {34.477, 35}, {37.477, 35}}, color = {1, 37, 163}));
  connect(propControl6.u[2], firstOrder.u) annotation(Line(visible = true, origin = {-79.062, 35}, points = {{-45.188, -35}, {14.062, -35}, {14.062, 35}, {17.062, 35}}, color = {1, 37, 163}));
  connect(propControl6.u[4], firstOrder2.u) annotation(Line(visible = true, origin = {-79.062, 2.5}, points = {{-45.188, -2.5}, {14.062, -2.5}, {14.062, 2.5}, {17.062, 2.5}}, color = {1, 37, 163}));
  connect(propControl6.u[3], firstOrder3.u) annotation(Line(visible = true, origin = {-5.11, 2.5}, points = {{-119.14, -2.5}, {38.713, -2.5}, {38.713, 2.5}, {41.713, 2.5}}, color = {1, 37, 163}));
