...
model PropControl6
  ...
  Modelica.Blocks.Interfaces.RealOutput u[6] annotation(Placement(visible = true, transformation(origin = {140.0, -0.0}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0), iconTransformation(origin = {107.5, 0.0}, extent = {{-7.5, -7.5}, {7.5, 7.5}}, rotation = 0)));
equation
  u = ExternalTry.ROVExtTry.PropSignal6(c);
