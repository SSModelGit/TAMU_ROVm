...
model BasicWorldTorque "External torque acting at frame_b, defined by 3 input signals"
  ...
  parameter UWmBody.UWTypes.ResolveInFrameB resolveInFrame = UWmBody.UWTypes.ResolveInFrameB.world "Frame in which torque is resolved (1: world, 2: frame_b, 3: frame_resolve)";
equation
