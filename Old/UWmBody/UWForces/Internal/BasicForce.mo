...
model BasicForce "Force acting between two frames, defined by 3 input signals"
  ...
  parameter UWmBody.UWTypes.ResolveInFrameAB resolveInFrame = UWmBody.UWTypes.ResolveInFrameAB.frame_b "Frame in which force is resolved (1: world, 2: frame_a, 3: frame_b, 4: frame_resolve)";
