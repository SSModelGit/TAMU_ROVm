...
model RollingWheelSetPulling "Rolling wheel set that is pulled by a force"
  ...
  UWmBody.UWForces.WorldForce force(animation = false) annotation(Placement(transformation(extent = {{-20, 60}, {0, 80}}, origin = {0, -10}, rotation = 0), visible = true));
  UWmBody.UWVisualizers.Ground ground(length = 3) annotation(Placement(transformation(extent = {{-20, -40}, {0, -20}}, origin = {-10, -30}, rotation = 0), visible = true));
  inner UWmBody.UWWorld world(label2 = "z", n = {0, 0, -1}) annotation(Placement(transformation(extent = {{-60, 0}, {-40, 20}}, origin = {-10, -30}, rotation = 0), visible = true));
  ...
  UWmBody.UWParts.Body body(m = 0.01, r_CM = {0, 0, 0}, animation = false) annotation(Placement(transformation(extent = {{42, 20}, {62, 40}}, origin = {-2, -20}, rotation = 0), visible = true));
  ...
  UWmBody.UWParts.FixedTranslation fixedTranslation(r = {0.2, 0, 0}, animation = true, width = 0.04) annotation(Placement(transformation(extent = {{0, 20}, {20, 40}}, origin = {-10, -20}, rotation = 0), visible = true));
