...
model DoublePendulumInitTip "Demonstrate how to initialize a double pendulum so that its tip starts at a predefined position"
  ...
  inner UWWorld world annotation(Placement(transformation(extent = {{-100, 0}, {-80, 20}}, origin = {0, -10}, rotation = 0), visible = true));
  UWJoints.Revolute revolute1(useAxisFlange = true) annotation(Placement(transformation(extent = {{-60, 0}, {-40, 20}}, origin = {0, -10}, rotation = 0), visible = true));
  ...
  UWParts.BodyBox boxBody1(r = {0.5, 0, 0}, width = 0.06) annotation(Placement(transformation(extent = {{-22, 0}, {-2, 20}}, origin = {0, -10}, rotation = 0), visible = true));
  UWJoints.Revolute revolute2 annotation(Placement(transformation(extent = {{20, 0}, {40, 20}}, origin = {0, -10}, rotation = 0), visible = true));
  UWParts.BodyBox boxBody2(r = {0.5, 0, 0}, width = 0.06) annotation(Placement(transformation(extent = {{62, 0}, {82, 20}}, origin = {-2, -10}, rotation = 0), visible = true));
  UWmBody.UWJoints.FreeMotionScalarInit freeMotionScalarInit(use_r = true, r_rel_a_1(start = 0.7, fixed = true), r_rel_a_2(start = 0.3, fixed = true), use_v = true, v_rel_a_1(fixed = true), v_rel_a_2(fixed = true)) annotation(Placement(transformation(extent = {{-20, -40}, {0, -20}}, origin = {0, -0}, rotation = 0), visible = true));
equation
...
<a href=\"modelica://UWmBody.Joints.FreeMotionScalarInit\">Joints.FreeMotionScalarInit</a>
