...
model Fourbar1 "One kinematic loop with four bars (with only revolute joints; 5 non-linear equations)"
  ...
  inner UWmBody.UWWorld world annotation(Placement(transformation(extent = {{-100, -80}, {-80, -60}}, origin = {10, -0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Revolute j1(n = {1, 0, 0}, stateSelect = StateSelect.always, phi(fixed = true), w(displayUnit = "deg/s", start = 5.235987755982989, fixed = true)) annotation(Placement(transformation(extent = {{-54, -40}, {-34, -20}}, origin = {4, -0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Prismatic j2(n = {1, 0, 0}, s(start = -0.2), boxWidth = 0.05) annotation(Placement(transformation(extent = {{10, -80}, {30, -60}}, origin = {-10, -0}, rotation = 0), visible = true));
  ...
  UWmBody.UWParts.BodyCylinder b2(r = {0, 0.2, 0}, diameter = 0.05) annotation(Placement(transformation(origin = {40, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWmBody.UWParts.BodyCylinder b3(r = {-1, 0.3, 0.1}, diameter = 0.05) annotation(Placement(transformation(extent = {{38, 20}, {18, 40}}, origin = {12, -0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Revolute rev(n = {0, 1, 0}) annotation(Placement(transformation(origin = {40, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWmBody.UWJoints.Revolute rev1 annotation(Placement(transformation(extent = {{60, 0}, {80, 20}}, origin = {-0, -0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Revolute j3(n = {1, 0, 0}) annotation(Placement(transformation(extent = {{-60, 40}, {-40, 60}}, origin = {10, 10}, rotation = 0), visible = true));
  UWmBody.UWJoints.Revolute j4(n = {0, 1, 0}) annotation(Placement(transformation(extent = {{-32, 60}, {-12, 80}}, origin = {22, -0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Revolute j5(n = {0, 0, 1}) annotation(Placement(transformation(extent = {{0, 70}, {20, 90}}, origin = {30, -0}, rotation = 0), visible = true));
  UWmBody.UWParts.FixedTranslation b0(animation = false, r = {1.2, 0, 0}) annotation(Placement(transformation(extent = {{-40, -80}, {-20, -60}}, origin = {0, -0}, rotation = 0), visible = true));
equation
