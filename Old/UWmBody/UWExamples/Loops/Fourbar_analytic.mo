...
model Fourbar_analytic "One kinematic loop with four bars (with JointSSP joint; analytic solution of non-linear algebraic loop)"
  ...
  inner UWmBody.UWWorld world(animateGravity = false) annotation(Placement(transformation(extent = {{-80, -60}, {-60, -40}}, origin = {0, 0}, rotation = 0), visible = true));
  ...
  UWmBody.UWParts.FixedTranslation b3(r = {1.2, 0, 0}, animation = false) annotation(Placement(transformation(extent = {{-32, -60}, {-12, -40}}, origin = {10, 0}, rotation = 0), visible = true));
  UWmBody.UWJoints.Assemblies.JointSSP jointSSP(rod1Length = sqrt({-1, 0.3, 0.1} * {-1, 0.3, 0.1}), n_b = {1, 0, 0}, s_offset = -0.2, rRod2_ib = {0, 0.2, 0}, rod1Color = {0, 128, 255}, rod2Color = {0, 128, 255}, checkTotalPower = true) annotation(Placement(transformation(extent = {{-20, 0}, {20, 40}}, origin = {10, 10}, rotation = 0), visible = true));
  UWmBody.UWParts.BodyCylinder b2(r = {0, 0.2, 0}, diameter = 0.05, animation = false) annotation(Placement(transformation(origin = {60, 30}, extent = {{10, -10}, {-10, 10}}, rotation = 90), visible = true));
equation
  j1_phi = j1.phi;
