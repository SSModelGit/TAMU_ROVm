...
partial model Engine1bBase "Model of one cylinder engine with gas force"
  UWmBody.UWParts.BodyCylinder Piston(diameter = 0.1, r = {0, -0.1, 0}) annotation(Placement(transformation(origin = {120, 50}, extent = {{-10, 20}, {10, -20}}, rotation = 270), visible = true));
  UWmBody.UWParts.BodyBox Rod2(widthDirection = {1, 0, 0}, width = 0.02, height = 0.06, color = {0, 0, 200}, r = {0, 0.2, 0}) annotation(Placement(transformation(origin = {120, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWmBody.UWJoints.Revolute Bearing(useAxisFlange = true, n = {1, 0, 0}, cylinderLength = 0.02, cylinderDiameter = 0.05) annotation(Placement(transformation(extent = {{-50, -80}, {-30, -100}})));
  inner UWmBody.UWWorld world annotation(Placement(transformation(extent = {{-90, -100}, {-70, -80}})));
  ...
  UWmBody.UWParts.BodyBox Crank4(height = 0.05, widthDirection = {1, 0, 0}, width = 0.02, r = {0, -0.1, 0}) annotation(Placement(transformation(origin = {80, -75}, extent = {{10, -10}, {-10, 10}}, rotation = 90), visible = true));
  UWmBody.UWParts.BodyCylinder Crank3(r = {0.1, 0, 0}, diameter = 0.03) annotation(Placement(transformation(extent = {{41.5, -71}, {61.5, -51}}, origin = {3.5, 1}, rotation = 0), visible = true));
  UWmBody.UWParts.BodyCylinder Crank1(diameter = 0.05, r = {0.1, 0, 0}) annotation(Placement(transformation(extent = {{-16, -100}, {4, -80}}, origin = {-4, 0}, rotation = 0), visible = true));
  UWmBody.UWParts.BodyBox Crank2(height = 0.05, widthDirection = {1, 0, 0}, width = 0.02, r = {0, 0.1, 0}) annotation(Placement(transformation(origin = {30, -75}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWmBody.UWParts.FixedTranslation Mid(r = {0.05, 0, 0}) annotation(Placement(transformation(extent = {{30, -53}, {50, -33}}, origin = {0, -2}, rotation = 0), visible = true));
  UWmBody.UWParts.FixedTranslation cylPosition(animation = false, r = {0.15, 0.55, 0}) annotation(Placement(transformation(extent = {{-40.5, 100}, {-20.5, 120}}, origin = {0.5, 0}, rotation = 0), visible = true));
  Utilities.GasForce2 gasForce(d = 0.1, L = 0.35) annotation(Placement(transformation(origin = {120, 95}, extent = {{10, -10}, {-10, 10}}, rotation = 90), visible = true));
equation
