...
model GearConstraint "Demonstrate usage of GearConstraint model"
  ...
  UWJoints.GearConstraint gearConstraint(ratio = 10, phi_b(fixed = true), w_b(fixed = true), checkTotalPower = true) annotation(Placement(transformation(extent = {{34, 40}, {54, 60}}, origin = {6, 0}, rotation = 0), visible = true));
  inner UWWorld world(driveTrainMechanics3D = true, g = 0) annotation(Placement(transformation(extent = {{-62, 10}, {-42, 30}}, origin = {2, 0}, rotation = 0), visible = true));
  UWParts.BodyCylinder cyl1(diameter = 0.1, color = {0, 128, 0}, r = {0.4, 0, 0}) annotation(Placement(transformation(extent = {{2, 40}, {22, 60}}, origin = {8, 0}, rotation = 0), visible = true));
  UWParts.BodyCylinder cyl2(r = {0.4, 0, 0}, diameter = 0.2) annotation(Placement(transformation(extent = {{70, 40}, {90, 60}}, origin = {0, 0}, rotation = 0), visible = true));
  UWForces.Torque torque1 annotation(Placement(transformation(extent = {{-26, 40}, {-6, 60}}, origin = {6, 0}, rotation = 0), visible = true));
  Blocks.Sources.Sine sine[3](amplitude = {2, 0, 0}, freqHz = {1, 1, 1}) annotation(Placement(transformation(extent = {{-100, 60}, {-80, 80}}, origin = {0, 0}, rotation = 0), visible = true));
  UWParts.Fixed fixed annotation(Placement(transformation(extent = {{-48, -90}, {-28, -70}}, origin = {-2, 10}, rotation = 0), visible = true));
  ...
  UWParts.Mounting1D mounting1D annotation(Placement(transformation(extent = {{-20, -70}, {0, -50}}, origin = {-10, 10}, rotation = 0), visible = true));
equation
