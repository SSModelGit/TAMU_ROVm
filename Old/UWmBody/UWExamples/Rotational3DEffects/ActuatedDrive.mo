...
model ActuatedDrive "Demonstrates usage of models Rotor1D and Mounting1D"
  ...
  UWParts.BodyShape bodyCylinder(r = {0.5, 0, 0}, m = 0, I_11 = 2, I_22 = 0, I_33 = 0, shapeType = "cylinder", width = 0.1, animateSphere = false, r_shape = {0.1, 0, 0}, r_CM = {0, 0, 0}) annotation(Placement(transformation(extent = {{8, 0}, {28, 20}}, origin = {22, 10}, rotation = 0), visible = true));
  UWJoints.Revolute revolute(n = {1, 0, 0}, a(fixed = false), phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{-26, 0}, {-6, 20}}, origin = {26, 10}, rotation = 0), visible = true));
  inner UWWorld world(g = 0, driveTrainMechanics3D = true) annotation(Placement(transformation(extent = {{-60, 0}, {-40, 20}}, origin = {20, 10}, rotation = 0), visible = true));
  UWForces.Torque torque annotation(Placement(transformation(extent = {{8, 30}, {28, 50}}, origin = {22, 10}, rotation = 0), visible = true));
  Blocks.Sources.Sine sine[3](amplitude = {1, 0, 0}, freqHz = {1, 1, 1}) annotation(Placement(transformation(extent = {{-80, 60}, {-60, 80}}, origin = {20, 10}, rotation = 0), visible = true));
  inner UWParts.Fixed fixed annotation(Placement(transformation(extent = {{-62, -90}, {-42, -70}}, origin = {12, 10}, rotation = 0), visible = true));
  UWParts.Rotor1D rotor1D(J = 2, phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{0, -40}, {20, -20}}, origin = {20, 10}, rotation = 0), visible = true));
  ...
  UWParts.Mounting1D mounting1D annotation(Placement(transformation(extent = {{-46, -60}, {-26, -40}}, origin = {16, 10}, rotation = 0), visible = true));
equation
