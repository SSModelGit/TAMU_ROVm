...
model MovingActuatedDrive "Demonstrates usage of model Rotor1D mounted on a moving body"
  ...
  UWParts.BodyShape bodyCylinder(r = {0.5, 0, 0}, m = 0, I_11 = 2, I_22 = 0, I_33 = 0, shapeType = "cylinder", width = 0.1, animateSphere = false, r_shape = {0.1, 0, 0}, r_CM = {0, 0, 0}) annotation(Placement(transformation(extent = {{50, 10}, {70, 30}})));
  UWJoints.Revolute revolute(n = {1, 0, 0}, a(fixed = false), phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{16, 10}, {36, 30}}, origin = {4, 0}, rotation = 0), visible = true));
  inner UWWorld world(g = 0, driveTrainMechanics3D = true) annotation(Placement(transformation(extent = {{-84, 10}, {-64, 30}}, origin = {4, 0}, rotation = 0), visible = true));
  UWForces.Torque torque annotation(Placement(transformation(extent = {{50, 40}, {70, 60}})));
  Blocks.Sources.Sine sine1[3](amplitude = {1, 0, 0}, freqHz = {1, 1, 1}) annotation(Placement(transformation(extent = {{16, 70}, {36, 90}}, origin = {4, 0}, rotation = 0), visible = true));
  UWParts.Rotor1D rotor1D(J = 2, phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{50, -36}, {70, -16}}, origin = {-0, -4}, rotation = 0), visible = true));
  ...
  UWParts.Mounting1D mounting1D annotation(Placement(transformation(extent = {{4, -56}, {24, -36}}, origin = {-4, -4}, rotation = 0), visible = true));
  UWJoints.Revolute r1(useAxisFlange = true, n = {0, 1, 0}) annotation(Placement(transformation(extent = {{-32, 10}, {-12, 30}}, origin = {12, 0}, rotation = 0), visible = true));
  ...
  Blocks.Sources.Sine sine2(amplitude = 2, freqHz = 1) annotation(Placement(transformation(extent = {{-100, 60}, {-80, 80}})));
  UWParts.Mounting1D mounting1D1(n = {0, 1, 0}) annotation(Placement(transformation(extent = {{-60, 34}, {-40, 54}}, origin = {0, -4}, rotation = 0), visible = true));
  UWJoints.Revolute r2(useAxisFlange = true, n = {0, 1, 0}) annotation(Placement(transformation(extent = {{-38, -80}, {-18, -60}}, origin = {8, 0}, rotation = 0), visible = true));
  ...
  UWParts.Mounting1D mounting1D2(n = {0, 1, 0}) annotation(Placement(transformation(extent = {{-66, -56}, {-46, -36}}, origin = {-4, -4}, rotation = 0), visible = true));
  UWParts.Fixed fixed annotation(Placement(transformation(extent = {{-86, -80}, {-66, -60}}, origin = {-4, 0}, rotation = 0), visible = true));
equation
