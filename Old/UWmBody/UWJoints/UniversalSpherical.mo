...
model UniversalSpherical "Universal - spherical joint aggregation (1 constraint, no potential states)"
  import UWmBody.UWTypes;
  extends UWInterfaces.PartialTwoFrames;
  UWInterfaces.Frame_a frame_ia "Coordinate system at the origin of frame_a, fixed at the rod connecting the universal with the spherical joint" annotation(Placement(transformation(origin = {-40, 100}, extent = {{-16, -16}, {16, 16}}, rotation = 270)));
  ...
  parameter UWmBody.UWTypes.Axis n1_a = {0, 0, 1} "Axis 1 of universal joint resolved in frame_a (axis 2 is orthogonal to axis 1 and to rod)" annotation(Evaluate = true);
  ...
  input UWTypes.Color sphereColor = UWmBody.UWTypes.Defaults.JointColor "Color of spheres representing the universal and the spherical joint" annotation(Dialog(colorSelector = true, tab = "Animation", group = "if animation = true", enable = animation));
  parameter UWTypes.ShapeType rodShapeType = "cylinder" "Shape type of rod connecting the universal and the spherical joint" annotation(Dialog(tab = "Animation", group = "if animation = true", enable = animation));
  ...
  parameter UWTypes.ShapeExtra rodExtra = 0.0 "Additional parameter depending on rodShapeType" annotation(Dialog(tab = "Animation", group = "if animation = true", enable = animation));
  input UWTypes.Color rodColor = UWmBody.UWTypes.Defaults.RodColor "Color of rod shape connecting the universal and the spherical joints" annotation(Dialog(colorSelector = true, tab = "Animation", group = "if animation = true", enable = animation));
  ...
  final parameter SI.Distance rodLength(fixed = false, start = Modelica.Math.Vectors.length(rRod_ia)) "Length of rod (distance between origin of frame_a and origin of frame_b)";
  final parameter Real eRod_ia[3](each final unit = "1") = Modelica.Math.Vectors.normalizeWithAssert(rRod_ia) "Unit vector from origin of frame_a to origin of frame_b, resolved in frame_ia";
...
protected
  ...
  UWFrames.Orientation R_rel_ia1;
  UWFrames.Orientation R_rel_ia2;
  // Real T_rel_ia[3, 3];
  UWFrames.Orientation R_rel_ia "Rotation from frame_a to frame_ia";
  UWVisualizers.Advanced.Shape rodShape(shapeType = rodShapeType, color = rodColor, specularCoefficient = specularCoefficient, length = rodLength, width = rodWidth, height = rodHeight, lengthDirection = eRod_ia, widthDirection = e2_ia, r = frame_ia.r_0, R = frame_ia.R) if world.enableAnimation and animation;
  UWVisualizers.Advanced.Shape sphericalShape_b(shapeType = "sphere", color = sphereColor, specularCoefficient = specularCoefficient, length = sphereDiameter, width = sphereDiameter, height = sphereDiameter, lengthDirection = {1, 0, 0}, widthDirection = {0, 1, 0}, r_shape = {-0.5, 0, 0} * sphereDiameter, r = frame_b.r_0, R = frame_b.R) if world.enableAnimation and animation;
  UWVisualizers.Advanced.Shape sphericalShape_a(shapeType = "sphere", color = sphereColor, specularCoefficient = specularCoefficient, length = sphereDiameter, width = sphereDiameter, height = sphereDiameter, lengthDirection = {1, 0, 0}, widthDirection = {0, 1, 0}, r_shape = {-0.5, 0, 0} * sphereDiameter, r = frame_a.r_0, R = frame_a.R) if world.enableAnimation and animation and not showUniversalAxes;
  UWVisualizers.Advanced.Shape universalShape1(shapeType = "cylinder", color = cylinderColor, specularCoefficient = specularCoefficient, length = cylinderLength, width = cylinderDiameter, height = cylinderDiameter, lengthDirection = n1_a, widthDirection = {0, 1, 0}, r_shape = -n1_a * (cylinderLength / 2), r = frame_a.r_0, R = frame_a.R) if world.enableAnimation and animation and showUniversalAxes;
  UWVisualizers.Advanced.Shape universalShape2(shapeType = "cylinder", color = cylinderColor, specularCoefficient = specularCoefficient, length = cylinderLength, width = cylinderDiameter, height = cylinderDiameter, lengthDirection = e2_ia, widthDirection = {0, 1, 0}, r_shape = -e2_ia * (cylinderLength / 2), r = frame_ia.r_0, R = frame_ia.R) if world.enableAnimation and animation and showUniversalAxes;
initial equation
...
equation
  ...
  assert(length2_n2_a > 1.e-10, "
    A UWmBody.UWJoints.UniversalSpherical joint (consisting of
    ...
    use instead UWmBody.UWJoints.SphericalSpherical, if this is
...
</html>"), Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1, grid = {10, 10}), graphics = {Rectangle(visible = true, origin = {-0.5, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-49.5, -5}, {49.5, 5}}), Text(visible = true, textColor = {64, 64, 64}, extent = {{-150, -90}, {150, -50}}, textString = "%name"), Text(visible = true, textColor = {128, 128, 128}, extent = {{-105, 86}, {-67, 118}}, textString = "ia"), Text(visible = true, textColor = {64, 64, 64}, extent = {{-24, 65}, {167, 95}}, textString = "%rRod_ia"), Ellipse(visible = true, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{40, -15}, {70, 15}}), Polygon(visible = true, rotation = 180, lineColor = {64, 64, 64}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-40.019, 25.992}, {-40.019, 25.992}, {-47.214, 28.972}, {-55, 30}, {-62.786, 28.972}, {-69.981, 25.992}, {-76.213, 21.213}, {-80.992, 14.981}, {-83.972, 7.786}, {-85, 0}, {-83.972, -7.786}, {-80.992, -14.981}, {-76.213, -21.213}, {-69.981, -25.992}, {-62.786, -28.972}, {-55, -30}, {-47.214, -28.972}, {-40.019, -25.992}, {-40.019, -25.992}, {-39.693, -36.955}, {-39.693, -36.955}, {-47.16, -39.224}, {-55, -40}, {-62.84, -39.224}, {-70.307, -36.955}, {-77.192, -33.279}, {-83.284, -28.284}, {-88.279, -22.192}, {-91.955, -15.307}, {-94.224, -7.84}, {-95, 0}, {-94.224, 7.84}, {-91.955, 15.307}, {-88.279, 22.192}, {-83.284, 28.284}, {-77.192, 33.279}, {-70.307, 36.955}, {-62.84, 39.224}, {-55, 40}, {-47.16, 39.224}, {-39.693, 36.955}, {-39.693, 36.955}}, smooth = Smooth.Bezier), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-16, 18.667}, {-18.667, 16}, {-18.667, -16}, {-16, -18.667}, {16, -18.667}, {18.667, -16}, {18.667, 16}, {16, 18.667}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {191, 191, 191}, fillPattern = FillPattern.Solid, points = {{13.333, 34.667}, {-24, 34.667}, {-34.667, 24}, {-34.667, 10.667}, {-37.333, 8}, {-37.333, -8}, {-34.667, -10.667}, {-34.667, -24}, {-24, -34.667}, {13.333, -34.667}, {13.333, -24}, {-18.667, -24}, {-24, -18.667}, {-24, 18.667}, {-18.667, 24}, {13.333, 24}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{-13.333, 13.333}, {32, 13.333}, {37.333, 8}, {53.333, 8}, {53.333, -8}, {37.333, -8}, {32, -13.333}, {-13.333, -13.333}}), Ellipse(visible = true, origin = {-60.237, 0}, rotation = 45, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-6, -6}, {6, 6}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.VerticalCylinder, points = {{-5.333, -24}, {-5.333, -18.667}, {5.333, -18.667}, {5.333, -24}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.VerticalCylinder, points = {{-5.333, 18.667}, {-5.333, 24}, {5.333, 24}, {5.333, 18.667}}), Line(visible = true, points = {{-40, 101}, {-40, 60}, {-60, 1}}, color = {128, 128, 128}, thickness = 0.5)}), Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, initialScale = 0.1, grid = {10, 10}), graphics = {Line(visible = true, points = {{-60, -70}, {60, -70}}, color = {10, 90, 224}, arrow = {Arrow.None, Arrow.Filled}, arrowSize = 20), Text(visible = true, textColor = {64, 64, 64}, extent = {{-56, -90}, {56, -71}}, textString = "rRod"), Line(visible = true, points = {{-50, 19}, {-30, 57}}, color = {10, 90, 224}), Text(visible = true, textColor = {64, 64, 64}, extent = {{-34, 62}, {8, 78}}, textString = "e2"), Polygon(visible = true, lineColor = {10, 90, 224}, points = {{-25, 64}, {-33, 56}, {-27, 53}, {-25, 64}}), Line(visible = true, points = {{-60, 34.288}, {-60, 65}}, color = {10, 90, 224}), Polygon(visible = true, lineColor = {10, 90, 224}, points = {{-60, 75}, {-64, 63}, {-56, 63}, {-60, 75}}), Text(visible = true, textColor = {64, 64, 64}, extent = {{-93, 62}, {-64, 82}}, textString = "n1"), Line(visible = true, points = {{-60, -35.179}, {-60, -72}}, color = {10, 90, 224}), Text(visible = true, extent = {{-31, -28}, {0, -7}}, textString = "eRod"), Line(visible = true, points = {{-60, 0}, {-5, 0}}, color = {10, 90, 224}), Polygon(visible = true, lineColor = {10, 90, 224}, points = {{7, 0}, {-5, 3}, {-5, -3}, {7, 0}}), Line(visible = true, points = {{60, -1}, {60, -72}}, color = {10, 90, 224}), Line(visible = true, points = {{-40, 100}, {-40, 70}, {-60, 0}}, color = {128, 128, 128}, thickness = 0.5), Text(visible = true, textColor = {64, 64, 64}, extent = {{-23, 10}, {26, 30}}, textString = " eRod*e2 = 0;  n1*e2 = 0"), Rectangle(visible = true, origin = {-0.5, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-49.5, -5}, {49.5, 5}}), Ellipse(visible = true, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{40, -15}, {70, 15}}), Polygon(visible = true, rotation = 180, lineColor = {64, 64, 64}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-40.019, 25.992}, {-40.019, 25.992}, {-47.214, 28.972}, {-55, 30}, {-62.786, 28.972}, {-69.981, 25.992}, {-76.213, 21.213}, {-80.992, 14.981}, {-83.972, 7.786}, {-85, 0}, {-83.972, -7.786}, {-80.992, -14.981}, {-76.213, -21.213}, {-69.981, -25.992}, {-62.786, -28.972}, {-55, -30}, {-47.214, -28.972}, {-40.019, -25.992}, {-40.019, -25.992}, {-39.693, -36.955}, {-39.693, -36.955}, {-47.16, -39.224}, {-55, -40}, {-62.84, -39.224}, {-70.307, -36.955}, {-77.192, -33.279}, {-83.284, -28.284}, {-88.279, -22.192}, {-91.955, -15.307}, {-94.224, -7.84}, {-95, 0}, {-94.224, 7.84}, {-91.955, 15.307}, {-88.279, 22.192}, {-83.284, 28.284}, {-77.192, 33.279}, {-70.307, 36.955}, {-62.84, 39.224}, {-55, 40}, {-47.16, 39.224}, {-39.693, 36.955}, {-39.693, 36.955}}, smooth = Smooth.Bezier), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, points = {{-16, 18.667}, {-18.667, 16}, {-18.667, -16}, {-16, -18.667}, {16, -18.667}, {18.667, -16}, {18.667, 16}, {16, 18.667}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {191, 191, 191}, fillPattern = FillPattern.Solid, points = {{13.333, 34.667}, {-24, 34.667}, {-34.667, 24}, {-34.667, 10.667}, {-37.333, 8}, {-37.333, -8}, {-34.667, -10.667}, {-34.667, -24}, {-24, -34.667}, {13.333, -34.667}, {13.333, -24}, {-18.667, -24}, {-24, -18.667}, {-24, 18.667}, {-18.667, 24}, {13.333, 24}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid, points = {{-13.333, 13.333}, {32, 13.333}, {37.333, 8}, {53.333, 8}, {53.333, -8}, {37.333, -8}, {32, -13.333}, {-13.333, -13.333}}), Ellipse(visible = true, origin = {-60.237, 0}, rotation = 45, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.HorizontalCylinder, extent = {{-6, -6}, {6, 6}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.VerticalCylinder, points = {{-5.333, -24}, {-5.333, -18.667}, {5.333, -18.667}, {5.333, -24}}), Polygon(visible = true, origin = {-60.237, 0}, lineColor = {64, 64, 64}, fillColor = {255, 255, 255}, fillPattern = FillPattern.VerticalCylinder, points = {{-5.333, 18.667}, {-5.333, 24}, {5.333, 24}, {5.333, 18.667}})}));
