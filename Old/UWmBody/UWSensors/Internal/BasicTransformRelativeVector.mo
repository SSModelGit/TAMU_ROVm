...
model BasicTransformRelativeVector "Transform relative vector in to another frame"
  ...
  import UWmBody.UWTypes.ResolveInFrameAB;
  extends UWmBody.UWSensors.Internal.PartialRelativeBaseSensor;
  ...
  parameter UWmBody.UWTypes.ResolveInFrameAB frame_r_out = frame_r_in "Frame in which vector r_out (= r_in in other frame) is resolved (world, frame_a, frame_b, or frame_resolve)";
