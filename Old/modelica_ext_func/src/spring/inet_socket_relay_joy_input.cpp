...
void storeCallback(const modelica_ext_func::ModROSspring::ConstPtr& inVal)
{
...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    ros::Publisher pub = nh.advertise<modelica_ext_func::ModROSspring>("model_values", 1);
    modelica_ext_func::ModROSspring val;
