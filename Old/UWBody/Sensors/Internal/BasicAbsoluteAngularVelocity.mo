...
model BasicAbsoluteAngularVelocity "Measure absolute angular velocity"
  ...
  parameter UWBody.Types.ResolveInFrameA resolveInFrame = UWBody.Types.ResolveInFrameA.frame_a "Frame in which output vector w is resolved (world, frame_a, or frame_resolve)";
equation
