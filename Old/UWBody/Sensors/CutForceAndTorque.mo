...
model CutForceAndTorque "Measure cut force and cut torque vector"
  ...
  extends UWBody.Sensors.Internal.PartialCutForceSensor;
protected
  ...
  UWBody.Interfaces.ZeroPosition zeroPosition if not resolveInFrame == UWBody.Types.ResolveInFrameA.frame_resolve annotation(Placement(transformation(extent = {{60, 30}, {80, 50}})));
equation
