...
model PathPlanning1 "Generate reference angles for fastest kinematic movement"
  ...
  Modelica.Blocks.Logical.TerminateSimulation terminateSimulation(condition = time >= path.endTime + swingTime) annotation(Placement(transformation(extent = {{-50, -30}, {30, -24}})));
equation
