...
model PrismaticConstraint "Body attached by one spring and two prismatic joints or constrained to environment"
  ...
  Joints.Prismatic jointPrismatic_x(stateSelect = StateSelect.never, n = {1, 0, 0}, s(fixed = true), v(fixed = true)) annotation(Placement(transformation(extent = {{80, -30}, {60, -10}}, origin = {-0, 10}, rotation = 0), visible = true));
  Joints.Prismatic jointPrismatic_y(stateSelect = StateSelect.never, n = {0, 1, 0}, s(fixed = true), v(fixed = true)) annotation(Placement(transformation(extent = {{40, -30}, {20, -10}}, origin = {-0, 10}, rotation = 0), visible = true));
  Joints.Constraints.Prismatic constraint(x_locked = false, y_locked = false) annotation(Placement(transformation(extent = {{60, 10}, {40, 30}}, origin = {-0, 10}, rotation = 0), visible = true));
  ...
  UWBody.Parts.FixedRotation fixedRotation(r = {0.2, -0.3, 0.2}, rotationType = UWBody.Types.RotationTypes.PlanarRotationSequence, angles = {10, 55, 68}) annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {90, -40}), visible = true));
