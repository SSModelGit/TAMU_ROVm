...
model Engine1b_analytic "Model of one cylinder engine with gas force and analytic loop handling"
  ...
  Joints.Assemblies.JointRRP jointRRP(n_a = {1, 0, 0}, n_b = {0, -1, 0}, animation = false, rRod1_ia = {0, 0.2, 0}, rRod2_ib = {0, -0.1, 0}) annotation(Placement(transformation(origin = {30, 55}, extent = {{-15, 15}, {15, -15}}, rotation = 90), visible = true));
equation
...
<a href=\"modelica://UWBody.Examples.Loops.Engine1b#diagram\">Loops.Engine1b</a>.
