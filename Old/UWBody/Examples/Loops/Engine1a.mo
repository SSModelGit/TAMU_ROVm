...
model Engine1a "Model of one cylinder engine"
  ...
  UWBody.Parts.BodyCylinder Piston(diameter = 0.1, r = {0, -0.1, 0}) annotation(Placement(transformation(origin = {40, 70}, extent = {{-10, 20}, {10, -20}}, rotation = 270), visible = true));
  UWBody.Parts.BodyBox Rod(widthDirection = {1, 0, 0}, width = 0.02, height = 0.06, r = {0, -0.2, 0}, color = {0, 0, 200}) annotation(Placement(transformation(origin = {40, 10}, extent = {{10, -10}, {-10, 10}}, rotation = 90), visible = true));
  UWBody.Joints.Revolute B2(n = {1, 0, 0}, cylinderLength = 0.02, cylinderDiameter = 0.05) annotation(Placement(transformation(extent = {{80, 22}, {100, 42}}, origin = {-50, 8}, rotation = 0), visible = true));
  UWBody.Joints.Revolute Bearing(useAxisFlange = true, n = {1, 0, 0}, cylinderLength = 0.02, cylinderDiameter = 0.05) annotation(Placement(transformation(extent = {{-10, -80}, {10, -100}}, origin = {-40, 0}, rotation = 0), visible = true));
  inner UWBody.World world annotation(Placement(transformation(extent = {{-50, -100}, {-30, -80}}, origin = {-40, 0}, rotation = 0), visible = true));
  ...
  UWBody.Parts.BodyBox Crank4(height = 0.05, widthDirection = {1, 0, 0}, width = 0.02, r = {0, -0.1, 0}) annotation(Placement(transformation(origin = {70, -75}, extent = {{10, -10}, {-10, 10}}, rotation = 90), visible = true));
  UWBody.Parts.BodyCylinder Crank3(r = {0.1, 0, 0}, diameter = 0.03) annotation(Placement(transformation(extent = {{81.5, -71}, {101.5, -51}}, origin = {-46.5, 1}, rotation = 0), visible = true));
  UWBody.Parts.BodyCylinder Crank1(diameter = 0.05, r = {0.1, 0, 0}) annotation(Placement(transformation(extent = {{24, -100}, {44, -80}}, origin = {-44, 0}, rotation = 0), visible = true));
  UWBody.Parts.BodyBox Crank2(r = {0, 0.1, 0}, height = 0.05, widthDirection = {1, 0, 0}, width = 0.02) annotation(Placement(transformation(origin = {20, -75}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  Joints.RevolutePlanarLoopConstraint B1(n = {1, 0, 0}, cylinderLength = 0.02, cylinderDiameter = 0.05) annotation(Placement(transformation(extent = {{80, -30}, {100, -10}}, origin = {-50, 0}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation Mid(r = {0.05, 0, 0}) annotation(Placement(transformation(extent = {{70, -53}, {90, -33}}, origin = {-50, -2}, rotation = 0), visible = true));
  UWBody.Joints.Prismatic Cylinder(boxWidth = 0.02, n = {0, -1, 0}, s(start = 0.15)) annotation(Placement(transformation(origin = {40, 95}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
  UWBody.Parts.FixedTranslation cylPosition(animation = false, r = {0.15, 0.45, 0}) annotation(Placement(transformation(extent = {{-0.5, 100}, {19.5, 120}}, origin = {-39.5, 0}, rotation = 0), visible = true));
equation
