...
model PlanarLoops_analytic "Mechanism with three planar kinematic loops and one degree-of-freedom with analytic loop handling (with JointRRR joints)"
  ...
  inner UWBody.World world annotation(Placement(transformation(extent = {{-94, -90}, {-74, -70}}, origin = {-1, 10}, rotation = 0), visible = true));
  UWBody.Joints.Assemblies.JointRRR jointRRR1(rRod1_ia = r1a, rRod2_ib = r1b, checkTotalPower = true) annotation(Placement(transformation(origin = {-20, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 270), visible = true));
  UWBody.Joints.Revolute rev(useAxisFlange = true, w(fixed = true)) annotation(Placement(transformation(origin = {-55, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWBody.Parts.FixedTranslation rod1(r = rv) annotation(Placement(transformation(origin = {-55, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWBody.Parts.FixedTranslation rod2(r = rh) annotation(Placement(transformation(extent = {{-50, -60}, {-30, -40}}, origin = {2.5, 10}, rotation = 0), visible = true));
  UWBody.Parts.Body body1(m = 1, cylinderColor = {155, 155, 155}, r_CM = jointRRR1.rRod1_ia / 2) annotation(Placement(transformation(origin = {5, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  ...
  UWBody.Joints.Assemblies.JointRRR jointRRR2(rRod1_ia = r2a, rRod2_ib = r2b, checkTotalPower = true) annotation(Placement(transformation(origin = {30, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 270), visible = true));
  UWBody.Parts.FixedTranslation rod3(r = rh) annotation(Placement(transformation(extent = {{0, -60}, {20, -40}}, origin = {-5, 10}, rotation = 0), visible = true));
  UWBody.Parts.Body body2(m = 1, cylinderColor = {155, 155, 155}, r_CM = jointRRR2.rRod1_ia / 2) annotation(Placement(transformation(origin = {55, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWBody.Joints.Assemblies.JointRRR jointRRR3(rRod1_ia = r3a, rRod2_ib = r3b, checkTotalPower = true) annotation(Placement(transformation(origin = {80, 10}, extent = {{-20, -20}, {20, 20}}, rotation = 270), visible = true));
  UWBody.Parts.FixedTranslation rod4(r = rh) annotation(Placement(transformation(extent = {{40, -60}, {60, -40}}, origin = {5, 10}, rotation = 0), visible = true));
  UWBody.Parts.Body body3(m = 1, cylinderColor = {155, 155, 155}, r_CM = jointRRR3.rRod1_ia / 2) annotation(Placement(transformation(origin = {105, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  Parts.Mounting1D mounting1D annotation(Placement(transformation(extent = {{-100, -50}, {-80, -30}}, origin = {-0, 10}, rotation = 0), visible = true));
equation
...
<p>
It is demonstrated how the UWBody.Joints.Assemblies.JointRRR joint can be
