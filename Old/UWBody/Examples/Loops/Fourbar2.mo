...
model Fourbar2 "One kinematic loop with four bars (with UniversalSpherical joint; 1 non-linear equation)"
  ...
  inner UWBody.World world annotation(Placement(transformation(extent = {{-80, -80}, {-60, -60}}, origin = {0, 0}, rotation = 0), visible = true));
  ...
  UWBody.Joints.Prismatic j2(n = {1, 0, 0}, boxWidth = 0.05, s(fixed = true, start = -0.2)) annotation(Placement(transformation(extent = {{12, -80}, {32, -60}}, origin = {-2, 0}, rotation = 0), visible = true));
  ...
  UWBody.Parts.BodyCylinder b2(r = {0, 0.2, 0}, diameter = 0.05) annotation(Placement(transformation(origin = {50, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
  UWBody.Joints.UniversalSpherical universalSpherical(n1_a = {0, 1, 0}, computeRodLength = true, rRod_ia = {-1, 0.3, 0.1}) annotation(Placement(transformation(extent = {{0, 18}, {-20, 38}}, origin = {20, 2}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation b3(r = {1.2, 0, 0}, animation = false) annotation(Placement(transformation(extent = {{-32, -80}, {-12, -60}}, origin = {2, 0}, rotation = 0), visible = true));
  UWBody.Visualizers.FixedFrame fixedFrame(color_x = {0, 0, 255}) annotation(Placement(transformation(origin = {14.003, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 90), visible = true));
equation
  j1_phi = j1.phi;
  j2_s = j2.s;
  j1_w = j1.w;
