...
model DoublePendulum "Simple double pendulum with two revolute joints and two bodies"
  ...
  inner UWBody.World world annotation(Placement(transformation(extent = {{-88, 0}, {-68, 20}}, origin = {-2, -10}, rotation = 0), visible = true));
  UWBody.Joints.Revolute revolute1(useAxisFlange = true, phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{-48, 0}, {-28, 20}}, origin = {-2, -10}, rotation = 0), visible = true));
  ...
  UWBody.Parts.BodyBox boxBody1(r = {0.5, 0, 0}, width = 0.06) annotation(Placement(transformation(extent = {{-10, 0}, {10, 20}}, origin = {-2, -10}, rotation = 0), visible = true));
  UWBody.Joints.Revolute revolute2(phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{32, 0}, {52, 20}}, origin = {-2, -10}, rotation = 0), visible = true));
  UWBody.Parts.BodyBox boxBody2(r = {0.5, 0, 0}, width = 0.06) annotation(Placement(transformation(extent = {{74, 0}, {94, 20}}, origin = {-4, -10}, rotation = 0), visible = true));
equation
