within UWBody.Examples.Elementary.Utilities;

function sineSurface "Function defining the characteristic of a moving sine in three dimensions"
  extends UWBody.Interfaces.partialSurfaceCharacteristic;
...
<a href=\"UWBody.Examples.Elementary.Surfaces\">Elementary.Surfaces</a>.
</p>
</html>"));
end sineSurface;
