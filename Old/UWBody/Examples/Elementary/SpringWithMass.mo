...
model SpringWithMass "Point mass hanging on a spring"
  ...
  inner UWBody.World world(animateGravity = false) annotation(Placement(transformation(extent = {{-40, 40}, {-20, 60}}, origin = {10, -20}, rotation = 0), visible = true));
  UWBody.Forces.Spring spring(s_unstretched = 0.2, m = 0.5, c = 40, width = 0.1, massDiameter = 0.07) annotation(Placement(transformation(origin = {20, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
  UWBody.Parts.Body body(r_0(start = {0, -0.3, 0}, each fixed = true), v_0(each fixed = true), angles_fixed = true, w_0_fixed = true, r_CM = {0, 0, 0}, m = 1) annotation(Placement(transformation(origin = {20, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
equation
