...
model RollingWheelSetDriving "Rolling wheel set that is driven by torques driving the wheels"
  ...
  UWBody.Visualizers.Ground ground(length = 3, groundColor = {0, 255, 0}) annotation(Placement(transformation(extent = {{-20, -60}, {0, -40}}, origin = {-30, -20}, rotation = 0), visible = true));
  inner UWBody.World world(label2 = "z", n = {0, 0, -1}) annotation(Placement(transformation(extent = {{-80, -60}, {-60, -40}}, origin = {0, -20}, rotation = 0), visible = true));
  ...
  UWBody.Parts.Body body(m = 0.01, r_CM = {0, 0, 0}, animation = false) annotation(Placement(transformation(extent = {{40, 56}, {60, 76}}, origin = {0, -26}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation fixedTranslation(r = {0.2, 0, 0}, animation = true, width = 0.04) annotation(Placement(transformation(extent = {{0, 56}, {20, 76}}, origin = {0, -26}, rotation = 0), visible = true));
