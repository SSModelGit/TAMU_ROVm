...
model LineForceWithTwoMasses "Demonstrate line force with two point masses using a JointUPS and alternatively a LineForceWithTwoMasses component"
  ...
  inner UWBody.World world annotation(Placement(transformation(extent = {{-80, 60}, {-60, 80}}, origin = {0, -0}, rotation = 0), visible = true));
  UWBody.Joints.Revolute revolute1(phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{-20, 60}, {0, 80}}, origin = {0, -0}, rotation = 0), visible = true));
  UWBody.Parts.BodyBox bodyBox1(r = {0.7, 0, 0}) annotation(Placement(transformation(extent = {{20, 60}, {40, 80}}, origin = {0, -0}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation rod1(r = {0, -0.9, 0}, width = 0.01, animation = false) annotation(Placement(transformation(origin = {-40, 55}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
  UWBody.Joints.Assemblies.JointUPS jointUPS(nAxis_ia = {0.7, 1.2, 0}, animation = true) annotation(Placement(transformation(extent = {{0, 50}, {20, 30}}, origin = {0, -0}, rotation = 0), visible = true));
  UWBody.Parts.Body body1(r_CM = 0.2 * jointUPS.eAxis_ia, cylinderDiameter = 0.05, animation = true, m = m, I_11 = 0, I_22 = 0, I_33 = 0) annotation(Placement(transformation(extent = {{-14, 14}, {-34, 34}}, origin = {4, -0}, rotation = 0), visible = true));
  UWBody.Parts.Body body2(r_CM = -0.2 * jointUPS.eAxis_ia, cylinderDiameter = 0.05, animation = true, m = m, I_11 = 0, I_22 = 0, I_33 = 0) annotation(Placement(transformation(extent = {{32, 14}, {52, 34}}, origin = {-2, -0}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation rod2(r = {0, 0.3, 0}, width = 0.01, animation = false) annotation(Placement(transformation(origin = {-40, 85}, extent = {{10, -10}, {-10, 10}}, rotation = 270), visible = true));
  ...
  UWBody.Joints.Revolute revolute2(phi(fixed = true), w(fixed = true)) annotation(Placement(transformation(extent = {{-20, -40}, {0, -20}})));
  UWBody.Parts.BodyBox bodyBox2(r = {0.7, 0, 0}) annotation(Placement(transformation(extent = {{20, -40}, {40, -20}})));
  UWBody.Parts.FixedTranslation rod3(width = 0.01, r = {0, -0.9, 0.3}, animation = false) annotation(Placement(transformation(origin = {-40, -45}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
  UWBody.Parts.FixedTranslation rod4(width = 0.01, r = {0, 0.3, 0.3}, animation = false) annotation(Placement(transformation(origin = {-40, -15}, extent = {{10, -10}, {-10, 10}}, rotation = 270), visible = true));
  ...
  UWBody.Forces.LineForceWithTwoMasses lineForceWithTwoMasses(L_a = 0.2, L_b = 0.2, cylinderLength_a = 0.2, cylinderLength_b = 1.2, massDiameterFaction = 2.2, m_a = m, m_b = m) annotation(Placement(transformation(extent = {{0, -50}, {20, -70}})));
equation
...
<ul>
<li> With <a href=\"modelica://UWBody.Joints.Assemblies.JointUPS\">JointUPS</a>:<br>
     UWBody.Joints.Assemblies.JointUPS is an aggregation
...
<li> With <a href=\"modelica://UWBody.Forces.LineForceWithTwoMasses\">LineForceWithTwoMasses</a>:<br>
     UWBody.Forces.LineForceWithTwoMasses is a line force component
