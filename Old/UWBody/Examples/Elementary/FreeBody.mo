...
model FreeBody "Free flying body attached by two springs to environment"
  ...
  inner UWBody.World world annotation(Placement(transformation(extent = {{-60, 20}, {-40, 40}}, origin = {-0, 0}, rotation = 0), visible = true));
  UWBody.Parts.FixedTranslation bar2(r = {0.8, 0, 0}, animation = false) annotation(Placement(transformation(extent = {{0, 20}, {20, 40}}, origin = {-0, 0}, rotation = 0), visible = true));
  UWBody.Forces.Spring spring1(width = 0.1, coilWidth = 0.005, numberOfWindings = 5, c = 20, s_unstretched = 0) annotation(Placement(transformation(origin = {-20, -0}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
  UWBody.Parts.BodyShape body(m = 1, I_11 = 1, I_22 = 1, I_33 = 1, r = {0.4, 0, 0}, r_CM = {0.2, 0, 0}, width = 0.05, r_0(start = {0.2, -0.5, 0.1}, each fixed = true), v_0(each fixed = true), angles_fixed = true, w_0_fixed = true, angles_start = {0.174532925199433, 0.174532925199433, 0.174532925199433}) annotation(Placement(transformation(extent = {{0, -40}, {20, -20}}, origin = {-0, 0}, rotation = 0), visible = true));
  UWBody.Forces.Spring spring2(c = 20, s_unstretched = 0, width = 0.1, coilWidth = 0.005, numberOfWindings = 5) annotation(Placement(transformation(origin = {40, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 270), visible = true));
equation
