...
model FreeMotion "Free motion joint (6 degrees-of-freedom, 12 potential states)"
  ...
  input Types.Color arrowColor = UWBody.Types.Defaults.SensorColor "Color of arrow" annotation(Dialog(colorSelector = true, tab = "Animation", group = "if animation = true", enable = animation));
  ...
  final parameter Frames.Orientation R_rel_start = UWBody.Frames.axesRotations(sequence_start, angles_start, zeros(3)) "Orientation object from frame_a to frame_b at initial time";
protected
