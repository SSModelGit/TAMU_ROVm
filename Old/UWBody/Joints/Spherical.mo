...
model Spherical "Spherical joint (3 constraints and no potential states, or 3 degrees-of-freedom and 3 states)"
  ...
  input Types.Color sphereColor = UWBody.Types.Defaults.JointColor "Color of sphere representing the spherical joint" annotation(Dialog(colorSelector = true, group = "if animation = true", enable = animation));
...
protected
  ...
  parameter Frames.Quaternions.Orientation Q_start = UWBody.Frames.to_Q(R_rel_start) "Quaternion orientation object from frame_a to frame_b at initial time";
