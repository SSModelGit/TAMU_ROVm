...
model Cylindrical "Cylindrical joint (2 degrees-of-freedom, 4 potential states)"
  ...
  parameter UWBody.Types.Axis n = {1, 0, 0} "Cylinder axis resolved in frame_a (= same as in frame_b)" annotation(Evaluate = true);
  ...
  input Types.Color cylinderColor = UWBody.Types.Defaults.JointColor "Color of cylinder" annotation(Dialog(colorSelector = true, tab = "Animation", group = "if animation = true", enable = animation));
