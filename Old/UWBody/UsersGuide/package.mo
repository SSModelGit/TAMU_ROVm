...
package UsersGuide "User's Guide of UWBody Library"
...
This package contains the User's Guide for the UWBody library.
</p>
<ol>
<li> <a href=\"modelica://UWBody.UsersGuide.Tutorial\">Tutorial</a>
gives an introduction into the most important aspects of the library.
</li>
<li> <a href=\"modelica://UWBody.UsersGuide.Upgrade\">Upgrade</a> describes
  how to upgrade from former versions, especially from the \"old\"
  ModelicaAdditions.MultiBody library.
</li>
<li> <a href=\"modelica://UWBody.UsersGuide.Literature\">Literature</a> provides
  references that have been used to design and implement this library.
</li>
<li> <a href=\"modelica://UWBody.UsersGuide.Contact\">Contact</a> provides
