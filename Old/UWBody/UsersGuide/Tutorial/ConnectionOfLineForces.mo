...
<a href=\"modelica://UWBody.Forces.Spring\">Spring</a>,
...
<a href=\"modelica://UWBody.Examples.Elementary.ThreeSprings\">ThreeSprings</a>:
</p>
...
<blockquote><pre>
frame_b.R = UWBody.Frames.nullRotation();
</pre></blockquote>
...
Due to the usage of overdetermined connectors in the UWBody library, the error
