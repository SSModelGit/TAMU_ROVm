...
class OverView "Overview of UWBody library"
...
<li>About <b>60 main components</b>, i.e., joint, force, part,
    ...
    connected via available flange connectors to UWBody
    components.</li>
...
<li> <b>Analytic solution of kinematic loops</b>. The non-linear
    ...
    available in the UWBody.Joints package. Assembly joints consist
