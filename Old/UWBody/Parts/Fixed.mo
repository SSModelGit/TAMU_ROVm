...
model Fixed "Frame fixed in the world frame at a given position"
  ...
  Interfaces.Frame_b frame_b "Coordinate system fixed in the world frame" annotation(Placement(transformation(extent = {{84, -16}, {116, 16}}, origin = {0, 0}, rotation = 0), visible = true, iconTransformation(origin = {0, 0}, extent = {{84, -16}, {116, 16}}, rotation = 0)));
