...
model BasicWorldForce "External force acting at frame_b, defined by 3 input signals"
  ...
  parameter UWBody.Types.ResolveInFrameB resolveInFrame = UWBody.Types.ResolveInFrameB.world "Frame in which force is resolved (1: world, 2: frame_b, 3: frame_resolve)";
equation
