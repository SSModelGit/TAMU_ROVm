...
model Spring "Linear translational spring with optional mass"
  ...
  input Types.Color massColor = UWBody.Types.Defaults.BodyColor "Color of mass point" annotation(Dialog(colorSelector = true, tab = "Animation", group = "if animation = true and showMass = true", enable = animation and showMass));
