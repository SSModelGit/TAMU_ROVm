within UWBody.Visualizers.Colors;

function colorMapToSvg "Save a color map on file in svg (scalable vector graphics) format"
  extends Modelica.Icons.Function;
  encapsulated type HeaderType = enumeration(svgBeginAndEnd, svgBegin, svgEnd, noHeader);
  import Modelica.Utilities.Streams.print;
  input Real colorMap[:, 3] "Color map to be stored in svg format" annotation(choices(choice = UWBody.Visualizers.Colors.ColorMaps.jet(), choice = UWBody.Visualizers.Colors.ColorMaps.hot(), choice = UWBody.Visualizers.Colors.ColorMaps.gray(), choice = UWBody.Visualizers.Colors.ColorMaps.spring(), choice = UWBody.Visualizers.Colors.ColorMaps.summer(), choice = UWBody.Visualizers.Colors.ColorMaps.autumn(), choice = UWBody.Visualizers.Colors.ColorMaps.winter()));
