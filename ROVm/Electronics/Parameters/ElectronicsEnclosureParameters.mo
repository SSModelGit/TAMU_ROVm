...
record ElectronicsEnclosureParameters "Record of parameters specific to the electronics enclosure"
  ...
  parameter SI.Mass m_EEnclosure = 1 "Mass of electronics enclosure";
  ...
  parameter SI.DimensionlessRatio c_d_EEnclosure = 1 "Drag coefficient of the electronics enclosure";
