...
record ElectronicsEnclosureParameters "Record of parameters specific to the electronics enclosure"
  ...
  parameter SI.Mass m_EEnclosure = 3.257 "Mass of electronics enclosure";
  parameter SI.Density d_EEnclosure = 925 "Density of electronics enclosure";
  parameter SI.Area A_EEnclosure = 0.3 "Overall cross sectional area of the electronics enclosure";
  parameter SI.DimensionlessRatio mu_d_EEnclosure = 0.2 "Drag coefficient of the electronics enclosure";
  parameter SI.RotationalDampingConstant k_d_EEnclosure = 10000 "Rotational drag coefficient of the electronics enclosure";
