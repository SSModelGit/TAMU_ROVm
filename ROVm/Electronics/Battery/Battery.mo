...
model Battery
  ...
  UnderwaterRigidBodyLibrary.Parts.BasicBody battery(A = A_Battery, animation = animation, r_CM = r_CM_Battery, m = m_Battery, mu_d = mu_d_Battery, density = d_Battery, k_d = k_d_Battery) annotation(Placement(visible = true, transformation(origin = {2.301, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  parameter SI.DimensionlessRatio mu_d_Battery "Drag coefficient of the battery enclosure";
