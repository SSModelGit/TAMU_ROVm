...
model EEnclosure
  ...
  RBodyInFluid.Parts.BasicBodyShape eEnclosure(A = A_EEnclosure, animation = animation, r_CM = r_CM_EEnclosure, m = m_EEnclosure, c_d = c_d_EEnclosure, density = d_EEnclosure, r = r_CM_EEnclosure * 2, color = color, shapeType = "modelica://ROVm/Resources/AssemBROV2R1.stl") annotation(Placement(visible = true, transformation(origin = {2.301, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
