...
model rubbishKing
  ...
  RBodyInFluid.Parts.BasicBodyShape basicBody1(c_d = 0, A = 0.5, r_CM = {0, 0, 1}, m = 5, density = 2000, r = {0, 0, 1}, r_0.fixed = true, r_0.start = {0, 0, 0}) annotation(Placement(visible = true, transformation(origin = {-30, -25}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
