...
model PropMountTest
  // UnderwaterRigidBodyLibrary.Parts.BasicPropMount basicPropMount annotation(Placement(visible = true, transformation(origin = {7.592, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  /*prop_R = {0.1, 0, 0}*/
  UnderwaterRigidBodyLibrary.Parts.BasicBody basicBody(density = 1000, c_d = 1, A = 0.5, r_CM = {0.1, 0, 0}, m = 5, r_0.start = {0, 0, 0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {-35, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  inner UnderwaterRigidBodyLibrary.Fields.WaterField waterField annotation(Placement(visible = true, transformation(origin = {-122.168, -22.432}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
