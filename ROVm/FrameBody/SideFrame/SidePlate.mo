...
equation
  ...
  connect(lumenUPosition.frame_a, sidePlate.frame_a) annotation(Line(visible = true, origin = {-22.756, 52.5}, points = {{-32.244, 52.5}, {9.744, 52.5}, {9.744, -52.5}, {12.756, -52.5}}, color = {95, 95, 95}));
