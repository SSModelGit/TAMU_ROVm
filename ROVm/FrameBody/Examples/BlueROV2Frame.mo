...
model BlueROV2Frame
  ...
  Electronics.ElectronicsEnclosure.EEnclosure eEnclosure(r_CM_EEnclosure = {1, 0, 0}, lf_pos = {0.9, 0, -0.2}, lb_pos = {0.1, 0, -0.2}, rf_pos = {0.9, 0, 0.2}, rb_pos = {0.1, 0, 0.2}, d_EEnclosure = 900, m_EEnclosure = 2, A_EEnclosure = 0.3, c_d_EEnclosure = 5, R_EEnclosure = 100) annotation(Placement(visible = true, transformation(origin = {-20, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  BottomFrame.BottomPlate bottomPlate annotation(Placement(visible = true, transformation(origin = {-2.071, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(topPiece.frame_SF, leftSide.frame_frontU) annotation(Line(visible = true, origin = {-66.113, 38.238}, points = {{16.143, 14.619}, {-8.071, 14.619}, {-8.071, -29.238}}, color = {95, 95, 95}));
  connect(topPiece1.frame_SF, leftSide.frame_backU) annotation(Line(visible = true, origin = {-67.303, -18.238}, points = {{14.194, -4.619}, {-7.097, -4.619}, {-7.097, 9.238}}, color = {95, 95, 95}));
