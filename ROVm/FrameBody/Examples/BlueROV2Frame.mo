...
model BlueROV2Frame
  ...
  Propeller.Examples.BasicProp basicProp annotation(Placement(visible = true, transformation(origin = {-40, 88.323}, extent = {{-10, -10}, {10, 10}}, rotation = -360)));
  Propeller.Examples.BasicProp basicProp1 annotation(Placement(visible = true, transformation(origin = {-60, 21.742}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electronics.Lumens.Lumen lumen(r_CM_Lumen = {0.02, 0, 0}, m_Lumen = 0.05, d_Lumen = 5000, A_Lumen = 0.0003, c_d_Lumen = 1, R_Lumen = 5) annotation(Placement(visible = true, transformation(origin = {-95, 33.476}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  Electronics.Lumens.Lumen lumen1(r_CM_Lumen = {0.02, 0, 0}, m_Lumen = 0.05, d_Lumen = 5000, A_Lumen = 0.0003, c_d_Lumen = 1, R_Lumen = 5) annotation(Placement(visible = true, transformation(origin = {-95, -30}, extent = {{10, 10}, {-10, -10}}, rotation = 0)));
  ...
  Propeller.Examples.BasicProp basicProp2 annotation(Placement(visible = true, transformation(origin = {-43.139, -60}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  ...
  Propeller.Examples.BasicProp basicProp3 annotation(Placement(visible = true, transformation(origin = {20, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electronics.Lumens.Lumen lumen2(r_CM_Lumen = {0.02, 0, 0}, m_Lumen = 0.05, d_Lumen = 5000, A_Lumen = 0.0003, c_d_Lumen = 1, R_Lumen = 5) annotation(Placement(visible = true, transformation(origin = {87.312, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Electronics.Lumens.Lumen lumen3(r_CM_Lumen = {0.02, 0, 0}, m_Lumen = 0.05, d_Lumen = 5000, A_Lumen = 0.0003, c_d_Lumen = 1, R_Lumen = 5) annotation(Placement(visible = true, transformation(origin = {87.312, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Propeller.Examples.BasicProp basicProp4 annotation(Placement(visible = true, transformation(origin = {46.59, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Propeller.Examples.BasicProp basicProp5 annotation(Placement(visible = true, transformation(origin = {45, -60}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
