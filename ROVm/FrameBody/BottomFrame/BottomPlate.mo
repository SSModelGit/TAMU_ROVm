...
model BottomPlate
  ...
  UnderwaterRigidBodyLibrary.Parts.BasicBody ballast1(m = m_ballast, r_CM = r_CM_ballast, density = d_ballast, mu_d = mu_d_ballast, A = A_Ballast, animation = animation, k_d = k_d_ballast) annotation(Placement(visible = true, transformation(origin = {-85, 32.929}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBody ballast2(m = m_ballast, r_CM = r_CM_ballast, density = d_ballast, mu_d = mu_d_ballast, A = A_Ballast, animation = animation, k_d = k_d_ballast) annotation(Placement(visible = true, transformation(origin = {75, 32.929}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBody ballast3(m = m_ballast, r_CM = r_CM_ballast, density = d_ballast, mu_d = mu_d_ballast, A = A_Ballast, animation = animation, k_d = k_d_ballast) annotation(Placement(visible = true, transformation(origin = {115, 95}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBody ballast4(m = m_ballast, r_CM = r_CM_ballast, density = d_ballast, mu_d = mu_d_ballast, A = A_Ballast, animation = animation, k_d = k_d_ballast) annotation(Placement(visible = true, transformation(origin = {83.34, -45}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBody ballast5(m = m_ballast, r_CM = r_CM_ballast, density = d_ballast, mu_d = mu_d_ballast, A = A_Ballast, animation = animation, k_d = k_d_ballast) annotation(Placement(visible = true, transformation(origin = {-90, -45}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  UnderwaterRigidBodyLibrary.Parts.BasicBodyShape bottomPlateU(density = d_plate, r = r_bP_Long, r_CM = r_CM_bP_Long, m = m_bP_Long, A = A_bP_Long, mu_d = mu_d_bP_Long, animation = animation, k_d = k_d_bP_Long) annotation(Placement(visible = true, transformation(origin = {-5, 66.951}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBodyShape bottomPlateB(density = d_plate, r = r_bP_Long, r_CM = r_CM_bP_Long, m = m_bP_Long, A = A_bP_Long, mu_d = mu_d_bP_Long, animation = animation, k_d = k_d_bP_Long) annotation(Placement(visible = true, transformation(origin = {-16.565, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  UnderwaterRigidBodyLibrary.Parts.BasicBodyShape bottomPlateC(density = d_plate, r = r_bP_Short, r_CM = r_CM_bP_Short, m = m_bP_Short, A = A_bP_Short, mu_d = mu_d_bP_Short, animation = animation, k_d = k_d_bP_Short) annotation(Placement(visible = true, transformation(origin = {52.785, 95.111}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  parameter SI.DimensionlessRatio mu_d_bP_Long = 1;
  parameter SI.RotationalDampingConstant k_d_bP_Long = 1;
  parameter SI.DimensionlessRatio mu_d_bP_Short = 1;
...
protected
  ...
  parameter Modelica.SIunits.DimensionlessRatio mu_d_ballast = 1;
