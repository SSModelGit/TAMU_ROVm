...
record FrameParameters "Contains common parameters for frames"
  ...
  parameter SI.Mass m_TP = 0.25 annotation(Dialog(tab = "Top Plate Specific"));
  parameter SI.Area A_TP = 0.0009 annotation(Dialog(tab = "Top Plate Specific"));
  parameter SI.DimensionlessRatio c_d_TP = 1 annotation(Dialog(tab = "Top Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_TP = 1 annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_Fairing = 1 annotation(Dialog(tab = "Top Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_Fairing = 1 annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.Mass m_SP = 2 annotation(Dialog(tab = "Side Plate Specific"));
  parameter SI.Area A_SP = 0.5 annotation(Dialog(tab = "Side Plate Specific"));
  parameter SI.DimensionlessRatio c_d_SP = 1 annotation(Dialog(tab = "Side Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_SP = 1 annotation(Dialog(tab = "Side Plate Specific"));
  ...
  parameter SI.Mass m_bP_Long = 0.25 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.Area A_bP_Long = 0.0009 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.DimensionlessRatio c_d_bP_Long = 1 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_bP_Long = 1 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.DimensionlessRatio c_d_bP_Short = 1 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_bP_Short = 1 annotation(Dialog(tab = "Bottom Plate Specific"));
