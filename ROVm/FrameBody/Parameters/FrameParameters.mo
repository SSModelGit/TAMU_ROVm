...
record FrameParameters "Contains common parameters for frames"
  ...
  parameter SI.Length TP_Width[3] = {0.3, 0, 0} annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_TP = 0 annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_SP = 0 annotation(Dialog(tab = "Side Plate Specific"));
  ...
  parameter SI.Length propVPos[3] = {0.5, 0.2, 0} "Position of vertical propeller from frame_a" annotation(Dialog(tab = "Side Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_bP_Long = 0 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.DimensionlessRatio c_d_bP_Short = 0 annotation(Dialog(tab = "Bottom Plate Specific"));
