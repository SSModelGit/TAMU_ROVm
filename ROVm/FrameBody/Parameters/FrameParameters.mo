...
record FrameParameters "Contains common parameters for frames"
  ...
  parameter SI.DimensionlessRatio c_d_TP = 0.15 annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_Fairing = 0.1 annotation(Dialog(tab = "Top Plate Specific"));
  ...
  parameter SI.DimensionlessRatio c_d_bP_Long = 0.5 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.RotationalDampingConstant k_d_bP_Long = 10000 annotation(Dialog(tab = "Bottom Plate Specific"));
  parameter SI.DimensionlessRatio c_d_bP_Short = 0.2 annotation(Dialog(tab = "Bottom Plate Specific"));
