...
model TopPiece
  ...
  parameter SI.Length r_TP[3] = {0.1, 0, 0};
  parameter SI.Length TP_Width[3] = {0, 0, 0.2};
  parameter SI.Length r_CM_TP[3] = r_TP / 2;
  parameter SI.Length r_CM_Fairing[3] = {0.05, 0, 0};
  ...
  Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedRotation(angle = 90, n = {0, 0, 1}, animation = animationFT) annotation(Placement(visible = true, transformation(origin = {-78.274, -37.272}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
protected
...
equation
  ...
  connect(fixedTranslation.frame_b, fixedRotation.frame_a) annotation(Line(visible = true, origin = {-94.137, -37.272}, points = {{-5.863, 0}, {5.863, 0}}, color = {95, 95, 95}));
  connect(fixedRotation.frame_b, fairing.frame_a) annotation(Line(visible = true, origin = {-58.001, -37.292}, points = {{-10.274, 0.02}, {2.42, 0.02}, {2.42, -0.02}, {5.433, -0.02}}, color = {95, 95, 95}));
