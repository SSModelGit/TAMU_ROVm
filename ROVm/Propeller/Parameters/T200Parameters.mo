...
record T200Parameters "Record of the propeller's parameters"
  ...
  parameter Modelica.SIunits.AngularMomentum k_loss = 1 "Viscous drag loss coefficient for propeller blades" annotation(Dialog(tab = "Propeller Body Specific"));
  parameter Real eta = 0.4 "Efficiency coefficient of the propeller, to translate torque to force" annotation(Dialog(tab = "Propeller Body Specific"));
