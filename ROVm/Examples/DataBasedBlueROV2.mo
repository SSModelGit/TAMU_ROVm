...
equation
  ...
  connect(combiTable1Ds.y[1], matrixGain.u[1]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(combiTable1Ds.y[2], matrixGain.u[2]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(combiTable1Ds.y[3], matrixGain.u[3]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(combiTable1Ds.y[4], matrixGain.u[4]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(combiTable1Ds.y[5], matrixGain.u[5]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(combiTable1Ds.y[6], matrixGain.u[6]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  ...
  annotation(experiment(StartTime = 647, StopTime = 730, __Wolfram_Algorithm = "dassl"), Diagram(coordinateSystem(extent = {{-220, -220}, {220, 220}}, preserveAspectRatio = true, initialScale = 0.1, grid = {5, 5})));
