...
equation
  ...
  connect(experimentData.y[1], matrixGain.u[1]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(experimentData.y[2], matrixGain.u[2]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(experimentData.y[3], matrixGain.u[3]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(experimentData.y[4], matrixGain.u[4]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(experimentData.y[5], matrixGain.u[5]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(experimentData.y[6], matrixGain.u[6]) annotation(Line(visible = true, origin = {-112.928, 150}, points = {{-7.794, 0}, {7.795, 0}}, color = {1, 37, 163}));
  connect(clock.y, experimentData.u) annotation(Line(visible = true, origin = {-153.861, 150}, points = {{-10.139, 0}, {10.139, 0}}, color = {1, 37, 163}));
