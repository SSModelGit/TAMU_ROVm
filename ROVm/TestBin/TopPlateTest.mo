...
model TopPlateTest
  ...
  FrameBody.TopFrame.TopPiece topPiece(mu_d_TP = 100, mu_d_Fairing = 100, d_plate.displayUnit = "g/cm3", A_TP.displayUnit = "m2", r_0.start = {0, 0, 0}, r_0.fixed = true) annotation(Placement(visible = true, transformation(origin = {-20, -2.416}, extent = {{-10, -10}, {10, 10}}, rotation = -360)));
