...
model PropellerTest
  ...
  RBodyInFluid.Parts.BasicBody basicBody(density = 950, c_d = 0.01, A = 1, r_CM = {0.5, 0, 0}, m = 1, k_d = 0.5) annotation(Placement(visible = true, transformation(origin = {127.851, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
