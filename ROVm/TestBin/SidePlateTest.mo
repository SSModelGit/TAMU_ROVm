...
model SidePlateTest
  inner UnderwaterRigidBodyLibrary.Fields.WaterField waterField annotation(Placement(visible = true, transformation(origin = {-130, -17.601}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
