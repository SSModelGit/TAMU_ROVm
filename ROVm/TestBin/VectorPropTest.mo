...
model VectorPropTest
  ...
  UnderwaterRigidBodyLibrary.Parts.BasicBody basicBody(density = 1000, c_d = 0, A = 0, r_CM = {0.5, -0.1, 0}, m = 5) annotation(Placement(visible = true, transformation(origin = {127.851, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
