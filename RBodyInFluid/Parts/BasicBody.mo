...
model BasicBody
  ...
  Modelica.Mechanics.MultiBody.Forces.WorldForce field "Overall external force due to fields" annotation(Placement(visible = true, transformation(origin = {-51.931, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
